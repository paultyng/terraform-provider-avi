...
* `prev_remote_image_ref` - (Optional) Remote image reference of previous base image. Field introduced in 30.1.1. Allowed in enterprise edition with any value, enterprise with cloud services edition.
...
* `remote_image_ref` - (Optional) Remote image reference of current base image. Field introduced in 30.1.1. Allowed in enterprise edition with any value, enterprise with cloud services edition.
