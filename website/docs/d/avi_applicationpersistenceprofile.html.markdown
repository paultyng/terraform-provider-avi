...
* `diameter_app_persistence_profile` - Specifies the diameter persistence profile parameters. Field introduced in 31.1.1. Allowed in enterprise edition with any value, enterprise with cloud services edition.
